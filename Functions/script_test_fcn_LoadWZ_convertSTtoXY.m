%script_test_fcn_LoadWZ_convertSTtoXY
% tests fcn_LoadWZ_convertSTtoXY.m
...
% ENU_points = fcn_LoadWZ_convertSTtoXY(ST_points,v_unit,fig_num);
...
ENU_points = [2,2];
fig_num = 1002;
[station, transverse] = fcn_LoadWZ_getXYtoStationTransverse(ENU_points,v_unit,fig_num);
...
[station2, transverse2] = fcn_LoadWZ_getXYtoStationTransverse(Transform_point,v_unit,fig_num);
v_unit2 = [station2,transverse2];

ST_points = [station, transverse];
[X_recalc, Y_recalc] = fcn_LoadWZ_getXYtoStationTransverse(ST_points,v_unit2,fig_num);
