function [LLA_trace, ENU_trace, STH_trace]  = fcn_PlotTestTrack_plot(...
...
%
%       See the script:
%       script_test_fcn_PlotTestTrack_plot.m for a full
%       test suite.
%
...
elseif input_coordinates_type == "STH"
    ...
    ENU_trace = fcn_LoadWZ_convertSTtoXY(STH_trace(:,1:2),reference_unit_tangent_vector);
