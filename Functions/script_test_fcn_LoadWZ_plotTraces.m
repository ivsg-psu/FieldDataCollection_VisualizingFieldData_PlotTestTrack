% script_test_fcn_LoadWZ_plotTraces.m
% This is a script to exercise the function: fcn_LoadWZ_plotTraces.m
...
fcn_LoadWZ_plotTraces(TraceNames,isPlotted);
...
%     TraceNames,isPlotted,plot_color,line_width,...
%     LLA_fig_num,ENU_fig_num,STH_fig_num,reference_unit_tangent_vector)
fcn_LoadWZ_plotTraces(TraceNames,isPlotted,[1 0 0],2,LLA_fig_num,ENU_fig_num,STH_fig_num,STH_transverse_vector);
...
fcn_LoadWZ_plotTraces(tempTrace);
...
fcn_LoadWZ_plotTraces(tempTrace,[],[1 0 0],2,LLA_fig_num,ENU_fig_num,STH_fig_num,STH_transverse_vector);
...
fcn_LoadWZ_plotTraces(tempTrace,[],[1 0 0],2,LLA_fig_num,ENU_fig_num,STH_fig_num,STH_transverse_vector, flag_plot_headers_and_tailers);
...
flag_plot_headers_and_tailers = 0;
flag_plot_points = 0;
fcn_LoadWZ_plotTraces(tempTrace,[],[1 0 0],2,LLA_fig_num,ENU_fig_num,STH_fig_num,STH_transverse_vector, flag_plot_headers_and_tailers, flag_plot_points);
